...
from automation_ak.dispatcher.conditions import evaluate_conditions
...
def _run_automation(automation, doc, trigger_type):
	...
	# Execute actions
	action_results = []
	from automation_ak.dispatcher.actions import execute_action
...
def run_cron_automations():
	...
	for auto_name in automations:
		...
		try:
			...
			frappe.log_error(
				f"AK Automation cron error: {auto_name}",
